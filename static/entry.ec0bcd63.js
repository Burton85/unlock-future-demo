...
/*! @__NO_SIDE_EFFECTS__ */ const vh = () => {
  ...
  wh = { nuxt: { buildId: '229b24f5-58c4-4947-9f82-35ceacccd223' } },
  Eh = uh(wh);
function Ch() {
  const e = de();
...
const Oi = [
    {
      ...
      component: () =>
        kt(
          () => import('./Digital.f2527d18.js'),
          [
            './Digital.f2527d18.js',
            './index.a104edb2.js',
            './book--disable.0f5f05c7.js'
          ],
          import.meta.url
        ).then(e => e.default || e)
    },
    ...
    },
    {
      ...
      component: () =>
        kt(
          () => import('./home.aa048594.js'),
          ['./home.aa048594.js', './index.a104edb2.js'],
          import.meta.url
        ).then(e => e.default || e)
    },
    {
...
`);
      const r = Number(n.statusCode || 500),
        ...
        c = s
          ? ko(() =>
              kt(
                () => import('./error-404.830d5832.js'),
                ['./error-404.830d5832.js', './error-404.95c28eb4.css'],
                import.meta.url
              ).then(f => f.default || f)
            )
          : ko(() =>
              kt(
                () => import('./error-500.df5c142f.js'),
                ['./error-500.df5c142f.js', './error-500.e798523c.css'],
                import.meta.url
              ).then(f => f.default || f)
            );
      return (f, d) => (
