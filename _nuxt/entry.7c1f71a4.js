...
/*! @__NO_SIDE_EFFECTS__ */ const vh = () => {
  ...
  wh = { nuxt: { buildId: 'e9c2355a-d8a5-40be-bb20-1eb693476053' } },
  Eh = uh(wh);
function Ch() {
  const e = de();
...
const Oi = [
    {
      ...
      component: () =>
        kt(
          () => import('./Digital.6328f278.js'),
          [
            './Digital.6328f278.js',
            './index.dc8cb350.js',
            './book--disable.b156224a.js'
          ],
          import.meta.url
        ).then(e => e.default || e)
    },
    ...
    },
    {
      ...
      component: () =>
        kt(
          () => import('./home.287ed214.js'),
          ['./home.287ed214.js', './index.dc8cb350.js'],
          import.meta.url
        ).then(e => e.default || e)
    },
    {
...
`);
      const r = Number(n.statusCode || 500),
        ...
        c = s
          ? ko(() =>
              kt(
                () => import('./error-404.ee84e29b.js'),
                ['./error-404.ee84e29b.js', './error-404.95c28eb4.css'],
                import.meta.url
              ).then(f => f.default || f)
            )
          : ko(() =>
              kt(
                () => import('./error-500.23e791aa.js'),
                ['./error-500.23e791aa.js', './error-500.e798523c.css'],
                import.meta.url
              ).then(f => f.default || f)
            );
      return (f, d) => (
